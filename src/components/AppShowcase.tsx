...
/* ═══════════════════════════════════════════
   DESKTOP SCREEN COMPONENTS — Wide Layouts
   ═══════════════════════════════════════════ */
      ...
      <Stagger>
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[16px] font-bold text-white tracking-tight">Alex Johnson</p>
          </div>
          <div className="flex items-center gap-2">
            <div className="px-2.5 py-1 rounded-lg bg-white/[0.06] border border-white/[0.08] text-[9px] font-semibold text-white/50">USD $</div>
            <div className="w-7 h-7 rounded-full bg-white/[0.06] border border-white/[0.08] flex items-center justify-center">
      ...
      <Stagger delay={0.15}>
        <div className="grid grid-cols-2 gap-2.5">
          <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-3.5">
            <p className="text-[9px] text-white/40 font-semibold mb-2.5">Quick Actions</p>
            <div className="grid grid-cols-4 gap-2">
              {[
                { icon: ArrowDownLeft, label: "Deposit", primary: true },
                { icon: ArrowUpRight, label: "Send" },
                ...
                <motion.div key={a.label} initial={{ y: 6, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.2 + i * 0.04 }}
                  className={`flex flex-col items-center gap-1 py-2.5 rounded-xl ${a.primary ? "bg-white text-[hsl(240,10%,8%)]" : "bg-white/[0.04] border border-white/[0.06]"}`}>
                  <a.icon className={`w-3.5 h-3.5 ${a.primary ? "" : "text-white/60"}`} />
                  <span className={`text-[8px] font-semibold ${a.primary ? "" : "text-white/50"}`}>{a.label}</span>
                </motion.div>
              ))}
            </div>
          </div>
          <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-3.5">
            <div className="flex items-center justify-between mb-2.5">
              <p className="text-[9px] text-white/40 font-semibold">Recent Activity</p>
              <span className="text-[8px] text-white/25">See all</span>
            </div>
            {[
              ...
              <motion.div key={tx.label} initial={{ x: -6, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.25 + i * 0.05 }}
                ...
                <p className="text-[10px] font-medium text-white flex-1">{tx.label}</p>
                <span className={`text-[10px] font-bold font-mono ${tx.positive ? "text-green-400" : "text-white/60"}`}>{tx.amount}</span>
              </motion.div>
            ))}
          </div>
        </div>
    ...
    <div className="p-5 space-y-3.5">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-1.5">
            {[
              ...
              <div key={tab.label} className={`flex items-center gap-1 px-2 py-1 rounded-lg text-[9px] font-semibold ${tab.active ? "bg-white/10 text-white border border-white/[0.08]" : "text-white/30"}`}>
              ...
              <motion.div key={a.code} initial={{ x: 8, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.2 + i * 0.05 }}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[8px] text-white/30">{a.code}</p>
                  </div>
                </div>
                <div className="text-right">
      ...
      <Stagger delay={0.3}>
        <div className="rounded-xl bg-white/[0.03] border border-white/[0.08] overflow-hidden">
          <div className="grid grid-cols-5 gap-2 px-3.5 py-2 border-b border-white/[0.06] text-[8px] text-white/30 font-semibold">
          ...
          <div className="space-y-2.5">
            <div className="grid grid-cols-4 gap-2">
              {[
                ...
                <motion.div key={ctrl.label} initial={{ y: 6, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.25 + i * 0.04 }}
                  className="flex flex-col items-center gap-1 py-2.5 rounded-xl bg-white/[0.03] border border-white/[0.06]">
                  <ctrl.icon className={`w-3.5 h-3.5 ${ctrl.color}`} />
                  <span className="text-[8px] text-white/40 font-medium">{ctrl.label}</span>
                </motion.div>
            ...
            <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-3.5">
              ...
              {[
                ...
                <motion.div key={cat.category} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.35 + i * 0.05 }} className="mb-2.5">
                  <div className="flex justify-between text-[9px] mb-1">
                    <span className="text-white/60 font-medium">{cat.category}</span>
                    <span className="text-white/80 font-semibold font-mono">{cat.amount}</span>
                  </div>
    ...
    <div className="p-5 space-y-3.5">
      <Stagger>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <PiggyBank className="w-4 h-4 text-green-400" />
            <p className="text-[16px] font-bold text-white tracking-tight">Savings</p>
          </div>
          <div className="px-2.5 py-1 rounded-full bg-green-500/10 border border-green-500/15 text-[9px] font-bold text-green-400">6% APY</div>
        </div>
      </Stagger>

      <Stagger delay={0.08}>
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-xl p-4 border border-white/[0.08] bg-gradient-to-br from-green-500/[0.04] to-white/[0.02] relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-3 gap-2 mt-3">
                {[
                  ...
                  <motion.div key={e.label} initial={{ y: 6, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.25 + i * 0.05 }}
                    className="p-2 rounded-xl bg-green-500/[0.06] border border-green-500/[0.08] text-center">
                    <e.icon className="w-3 h-3 text-green-400/70 mx-auto mb-0.5" />
                    <p className="text-[8px] text-white/40">{e.label}</p>
                    <p className="text-[10px] font-bold text-green-400 font-mono">{e.value}</p>
                  </motion.div>
                ))}
          ...
          <div className="space-y-2.5">
            <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-3.5">
              ...
              <div className="flex gap-2 mb-2">
                <div className="flex-1 h-8 rounded-xl bg-white/[0.04] border border-white/[0.06] flex items-center px-2.5">
                  <DollarSign className="w-3 h-3 text-white/25 mr-1" /><span className="text-[10px] text-white/20">Amount</span>
                </div>
                <div className="px-4 h-8 rounded-xl bg-green-500/20 border border-green-500/20 flex items-center"><span className="text-[9px] font-bold text-green-400">Save</span></div>
              </div>
              <div className="flex gap-1.5">
                {["$10", "$25", "$50", "$100"].map((amt) => (
                  <div key={amt} className="flex-1 py-1.5 rounded-lg bg-white/[0.04] border border-white/[0.06] text-center">
            ...
            <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-3.5">
              <p className="text-[9px] text-white/40 font-semibold mb-2">Recent Savings</p>
              {[
                ...
                <motion.div key={tx.label + i} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 + i * 0.05 }}
                  className="flex items-center justify-between py-1.5 border-b border-white/[0.04] last:border-0">
                  <div><p className="text-[10px] font-medium text-white">{tx.label}</p><p className="text-[8px] text-white/30">{tx.date}</p></div>
                  <span className="text-[10px] font-bold text-green-400 font-mono">{tx.amount}</span>
                </motion.div>
              ))}
            </div>
          </div>
      ...
      <Stagger delay={0.25}>
        <div className="rounded-xl bg-white/[0.03] border border-white/[0.08] p-3.5">
          ...
          <div className="flex justify-between mt-2">
            <div><p className="text-[8px] text-white/30">Now</p><p className="text-[10px] font-bold text-white font-mono">$12,450</p></div>
            <div><p className="text-[8px] text-white/30">6 months</p><p className="text-[10px] font-bold text-white/60 font-mono">$12,823</p></div>
            <div className="text-right"><p className="text-[8px] text-white/30">12 months</p><p className="text-[10px] font-bold text-amber-400 font-mono">$13,197</p></div>
          </div>
        </div>
      </Stagger>
    </div>
  ...
  return (
    <div className="p-5 space-y-3.5">
      <Stagger>
        <div className="flex items-center gap-2">
          <Send className="w-4 h-4 text-cyan-400" />
          <p className="text-[16px] font-bold text-white tracking-tight">Send Money</p>
        </div>
      </Stagger>
      ...
      <Stagger delay={0.08}>
        <div className="grid gap-3" style={{ gridTemplateColumns: "2fr 3fr" }}>
          <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-3.5">
            <p className="text-[9px] text-white/40 font-semibold mb-2.5">Contacts</p>
            <div className="relative mb-2.5">
              <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 w-3 h-3 text-white/25" />
              <div className="w-full h-7 rounded-xl bg-white/[0.04] border border-white/[0.06] pl-7 flex items-center">
                <span className="text-[9px] text-white/20">Search...</span>
              </div>
            </div>
            {[
              ...
              <motion.div key={c.name} initial={{ x: -6, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.15 + i * 0.05 }}
                className={`flex items-center gap-2.5 py-2 border-b border-white/[0.04] last:border-0 ${c.active ? "bg-white/[0.04] -mx-2 px-2 rounded-lg" : ""}`}>
                <div className={`w-7 h-7 rounded-full border flex items-center justify-center ${c.color}`}>
                  <span className="text-[9px] font-bold">{c.initials}</span>
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] font-semibold text-white">{c.name}</p>
                  <p className="text-[8px] text-white/30">{c.handle}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="space-y-2.5">
            ...
            <motion.div initial={{ y: 8, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.4 }}
              ...
              style={{ background: "linear-gradient(135deg, hsl(190 85% 40%), hsl(200 80% 50%))" }}>
              <ShieldCheck className="w-3.5 h-3.5" />Send $500.00<ArrowRight className="w-3.5 h-3.5" />
            </motion.div>
          </div>
        </div>
      </Stagger>
    ...
    <div className="p-5 space-y-3.5">
      <Stagger>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <BarChart3 className="w-4 h-4 text-purple-400" />
            <p className="text-[16px] font-bold text-white tracking-tight">Analytics</p>
          </div>
          <div className="flex gap-1.5">
            {["7D", "30D", "All"].map((t, i) => (
      ...
      <Stagger delay={0.18}>
        <div className="grid gap-3" style={{ gridTemplateColumns: "3fr 2fr" }}>
          <div className="rounded-xl bg-white/[0.03] border border-white/[0.08] p-3.5">
            <p className="text-[9px] text-white/40 font-semibold mb-2.5">Weekly Spending</p>
            <div className="flex items-end justify-between gap-2 h-[88px] px-1">
              {[
          ...
          <div className="rounded-xl bg-white/[0.03] border border-white/[0.08] p-3.5">
            <p className="text-[9px] text-white/40 font-semibold mb-2.5">By Category</p>
